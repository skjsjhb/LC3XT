    ...
    switch (bs) {
        case "CMake":
            return "cd /lc3 && " +
                ...
                "cmake --build . &&" +
                "timeout 1 $(find . -type f -maxdepth 1 -executable -print -quit) < ../_input.arc | head -c 4k >" +
                " ../_output.arc";
        case "Makefile":
            return "cd /lc3 && " +
        ...
        case "PlainC":
            return "cd /lc3 && " +
                "clang -O2 *.c && timeout 1 ./a.out < _input.arc | head -c 4k > _output.arc";
        case "PlainCpp":
            return "cd /lc3 && " +
                "clang++ -O2 $(find . -type f -maxdepth 1 \\( -iname \"*.cc\" -o -iname \"*.c\" -o -iname \"*.cxx\"" +
                " -o -iname \"*.cpp\" \\)) && timeout 1" +
                " ./a.out < _input.arc | head -c 4k > _output.arc";
        case "Node":
            return "cd /lc3 && " +
                "[ -f main.ts ] && timeout 1 bun main.ts < _input.arc | head -c 4k > _output.arc || " +
                "timeout 1 bun main.js < _input.arc | head -c 4k > _output.arc";
        case "Python":
            return "cd /lc3 && " +
